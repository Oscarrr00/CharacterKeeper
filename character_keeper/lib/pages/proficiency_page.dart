  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Center(child: Text("Skill Proficiencies", style: Theme.of(context).textTheme.headline6,)),          
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                      Text("Proficiency Bonus", style: TextStyle(fontWeight: FontWeight.bold),),
                      Padding(
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        Expanded(child: Center(child: Text("Skill Proficiencies", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))))
                      ],),
                    ),
            ...
            Row(
              children: [
                Expanded(
                  child: ElevatedButton(child: Text("Edit Proficiencies"), onPressed: (){
